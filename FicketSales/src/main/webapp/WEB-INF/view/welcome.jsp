            ...
            if(totalPayment>0){
		            ...
		            $.ajax({
		                ...
		                success: function(result) {
		                    ...
		                    TEST_URL = "https://sandbox.paymentsgateway.net/swp/co/default.aspx?pg_api_login_id=S6rL6viS20&pg_schedule_quantity=1&pg_schedule_frequency=0&pg_schedule_quantity=1&pg_scheduled_transaction=0&pg_return_url=http%3A%2F%2F52.37.10.111:8080%2Fevents%2Fpmtresponse&pg_continue_description=back+to+Chinmayadc.org&x=320&y=57";
